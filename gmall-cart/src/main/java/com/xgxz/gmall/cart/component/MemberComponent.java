package com.xgxz.gmall.cart.component;
...
public class MemberComponent {
    ...
    public UserCartKey getCartKey(String accessToken, String cartKey){
        ...
        if (member != null){
            ...
            userCartKey.setLogin(false);
            userCartKey.setFinalCartKey(CartConstant.TEMP_CART_KEY_PREFIX + token);
            userCartKey.setTempCartKey(token);
            return userCartKey;
        }
    }
