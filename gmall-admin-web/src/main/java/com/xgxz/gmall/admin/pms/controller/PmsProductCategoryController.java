package com.xgxz.gmall.admin.pms.controller;

import com.alibaba.dubbo.config.annotation.Reference;
import com.xgxz.gmall.vo.product.PmsProductCategoryParam;
...
public class PmsProductCategoryController {
    ...
    public Object listWithChildren() {
        ...
        // 查询所有一级分类及子分类
        List<PmsProductCategoryWithChildrenItem> items = productCategoryService.listCatalogWithChildren(0);
