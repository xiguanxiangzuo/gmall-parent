...
import com.xgxz.gmall.admin.ums.vo.UmsAdminParam;
import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.xgxz.gmall.admin.utils.JwtTokenUtil;
...
public class UmsAdminController {
    ...
    public Object register(@Valid @RequestBody UmsAdminParam umsAdminParam, BindingResult result) {
        ...
        if (errorCount>0){
            ...
            fieldErrors.forEach((fieldError)->{
                log.debug("属性：{}，传来的值是：{}，校验出错，出错的信息是：{}",
                        fieldError.getField(),
    ...
    public Object login(@RequestBody com.atguigu.gmall.admin.ums.vo.UmsAdminLoginParam umsAdminLoginParam, BindingResult result) {
        //去数据库登陆
